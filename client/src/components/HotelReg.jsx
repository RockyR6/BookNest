        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <div className='w-full mt-4'>
            ...
            <input
              ...
              value={name}
              id='name'
              className='border bg-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'
              required
              type='text'
          ...
          <div className='w-full mt-4 max-w-60 mr-auto'>
            ...
            <select
              ...
              value={city}
              id='city'
              className='border border-gray-200 rounded w-full px-3 pt-2.5 mt-1 outline-indigo-500 font-light'
              required
            >
