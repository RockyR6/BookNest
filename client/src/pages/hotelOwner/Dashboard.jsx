    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <img src={assets.totalBookingIcon} alt="" className='max-sm:hidden h-10'/>
          <div>
            <p className='flex flex-col sm:ml-4 font-medium'>Total Bookings</p>
        ...
        <img src={assets.totalRevenueIcon} alt="" className='max-sm:hidden h-10'/>
          <div>
            <p className='flex flex-col sm:ml-4 font-medium'>Total Revenue</p>
      ...
      <div className='w-full max-w-3xl text-left border bg-gray-300 rounded-lg max-h-80 overflow-y-scroll'>
          ...
          <tbody className='text-sm'>
            {dashboardData.bookings.map((item, index)=>(
              <tr key={index}>
                ...
                <td className='py-3 px-3 border-t border-gray-300 flex'>
