      ...
      <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32 bg-amber-300'>
          ...
          <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='flex flex-col'>
              ...
              <input
                ...
                value={guests}
                className='max-w-20 rounded border border-r-gray-300 px-3 py-2 mt-1.5 outline-none'
                required
                type='number'
                id='guests'
                placeholder='0'
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-15 text-gray-500'>
          <p>
            ...
            has a true city feeling. The price quoted is for two guests;
            please mark the number of guests to get the exact price for
            groups. Guests will be allocated ground floor according to
        ...
        <div className='flex flex-col items-start gap-4'>
          <div className='flex gap-4'>
            <img
              ...
              alt='host'
              className='h-14 w-14 md:h-18 md:rounded-full'
            />
            <div>
