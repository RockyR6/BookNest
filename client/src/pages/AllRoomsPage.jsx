...
const AllRoomsPage = () => {
  ...
  //filter and sort rooms based onthe selected filters and sort option
  ...
  return (
    <div className='bg-amber-300 flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-36 px-4 md:px-16 lg:px-24 xl:px-32'>
      {/* Rooms List */}
      <div>
        ...
        {filterdRooms.map((room) => (
          <div key={room._id} className='flex flex-col md:flex-row items-start pt-10 gap-6 border-b border-gray-300 last:pb-32 last:border-0'>
            <img
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                  {room.amenities.map((item, index) => (
                    <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'>
                      <img src={facilityIcons[item]} alt={item} className='w-5 h-4' />
